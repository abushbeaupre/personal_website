...
function filterTOC(lang) {
  ...
  // Define which sections belong to which language based on href
  const englishSections = ['#journal-articles', '#preprints'];
  const frenchSections = ['#articles-de-revues', '#pré-publications'];
  ...
  tocItems.forEach(li => {
    ...
    // Check if this is an English or French section
    const isEnglish = englishSections.includes(href);
    const isFrench = frenchSections.includes(href);
