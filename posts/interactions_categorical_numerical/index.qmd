...
-   **Want to visualize predictions?** Use `predictions()` to generate predicted means for plotting

There are many ways to use `marginaleffects` for these approaches. For more detail visit the [marginaleffects website](https://marginaleffects.com/).
